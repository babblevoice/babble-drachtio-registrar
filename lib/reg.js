...
class reg {
  ...
  * @method
   ...
   * <br> - calls the user remove method for the registration
   * @method
   */
  onexpire() {
  ...
  /**
   * Ends unregistration:
   * <br> - emits the unregister event with information on the registration
   * <br> - clears the optionsintervaltimer interval and regexpiretimer timeout
   * @method
   */
  destroy() {
   ...
   * <br>   which calls the options.consolelog method for an error or records the ping
   * @method
   */
  pingoptions() {
